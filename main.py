...
# print('D1-2 Fuel for fuel requirements sum: {}'.format(getFuelFuelRequirementsSum()))
# print(handleList('1,1,1,4,99,5,6,0,99', False))
# print(handleList(getLine(), 12, 2))
# findNoun100Verb(getLine())
